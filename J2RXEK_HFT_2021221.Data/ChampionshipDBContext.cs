...
namespace J2RXEK_HFT_2021221.Data
{
    public class ChampionshipDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelbuilder)
        {
            ...
            Driver LH = new Driver() { Id=1, TeamId = Merc.Id, Name = "Lewis Hamilton", Number = 44, DebutYear = "2007", IsChampion = true };
            Driver VB = new Driver() { Id = 2, TeamId = Merc.Id, Name = "Valtteri Bottas", Number = 77, DebutYear = "2013", IsChampion = false };
            Driver MV = new Driver() { Id = 3, TeamId = RedB.Id, Name = "Max Verstappen", Number = 33, DebutYear = "2014", IsChampion = false };
            Driver SP = new Driver() { Id = 4, TeamId = RedB.Id, Name = "Sergio Perez", Number = 11, DebutYear = "2011", IsChampion = false };
            Driver SV = new Driver() { Id = 5, TeamId = Ast.Id, Name = "Sebastian Vettel", Number = 5, DebutYear = "2007", IsChampion = true };
            Driver LS = new Driver() { Id = 6, TeamId = Ast.Id, Name = "Lance Stroll", Number = 18, DebutYear = "2017", IsChampion = false };
            Driver CL = new Driver() { Id = 7, TeamId = Ferr.Id, Name = "Charles Leclerc", Number = 16, DebutYear = "2018", IsChampion = false };
            Driver CS = new Driver() { Id = 8, TeamId = Ferr.Id, Name = "Carlos Sainz", Number = 55, DebutYear = "2015", IsChampion = false };
            Driver LN = new Driver() { Id = 9, TeamId = McL.Id, Name = "Lando Norris", Number = 4, DebutYear = "2019", IsChampion = false };
            Driver DR = new Driver() { Id = 10, TeamId = McL.Id, Name = "Daniel Ricciardo", Number = 3, DebutYear = "2011", IsChampion = false };
            Driver YT = new Driver() { Id = 11, TeamId = Alpha.Id, Name = "Yuki Tsunoda", Number = 22, DebutYear = "2021", IsChampion = false };
            Driver PG = new Driver() { Id = 12, TeamId = Alpha.Id, Name = "Pierre Gasly", Number = 10, DebutYear = "2017", IsChampion = false };
            Driver KR = new Driver() { Id = 13, TeamId = Alfa.Id, Name = "Kimi Raikkönen", Number = 7, DebutYear = "2001", IsChampion = true};
            Driver AG = new Driver() { Id = 14, TeamId = Alfa.Id, Name = "Antonio Giovinazzi", Number = 99, DebutYear = "2017", IsChampion = false };
            Driver FA = new Driver() { Id = 15, TeamId = Alp.Id, Name = "Fernando Alonso", Number = 14, DebutYear = "2001", IsChampion = true };
            Driver EO = new Driver() { Id = 16, TeamId = Alp.Id, Name = "Esteban Ocon", Number = 31, DebutYear = "2016", IsChampion = false };
            Driver GR = new Driver() { Id = 17, TeamId = Will.Id, Name = "George Russel", Number = 63, DebutYear = "2019", IsChampion = false };
            Driver NL = new Driver() { Id = 18, TeamId = Will.Id, Name = "Nicholas Latifi", Number = 6, DebutYear = "2020", IsChampion = false };
            Driver SCH = new Driver() { Id = 19, TeamId = Haas.Id, Name = "Mick Schumacher", Number = 47, DebutYear = "2021", IsChampion = false };
            Driver NM = new Driver() { Id = 20, TeamId = Haas.Id, Name = "Nikita Mazepin", Number = 9, DebutYear = "2021", IsChampion = false };
